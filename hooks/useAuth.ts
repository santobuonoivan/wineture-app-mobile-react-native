...
export const useAuth = () => {
  ...
  const signOut = () => {
    logout();
    // Al cerrar sesión, reinicializar idioma basado en dispositivo
    initializeLanguage();
